...
public class KubernetesApplicationTest {
    ...
    public static void main(String[] args) {
        String sql = "CREATE TABLE `datagen_source` (\n" +
                ...
                ");\n" +
                "\n" +
                "CREATE TEMPORARY FUNCTION MyLength AS 'com.chitu.bigdata.flink.udf.MyLength';\n" +
                "\n" +
                "insert into sink_hive.sdp_test.bigdata_hive_0922 select * from datagen_source;\n" +
                "\n" +
                "INSERT INTO print select MyLength(f_random_str) from datagen;\n";
        ...
        Application application = JSONObject.parseObject("{\n" +
                ...
                "  \"id\": 1141,\n" +
                "  \"jobName\": \"st-demo-pro-allownonrestoredstatetest11111\",\n" +
                "  \"jobType\": 2,\n" +
        ...
        //new KubernetesApplicationServiceImpl().start(application);

        new KubernetesApplicationServiceImpl().killCluster(application);


//        application.setJobId("3b114c343de0f158f6b2b25fc011427d");
//        new KubernetesApplicationServiceImpl().stop(application);


//        application.setJobId("1a7f0decb536a55df01b0e4710aeafdd");
//        application.setSavePoint("hdfs://bigbigworld/sdp/savepoints/1a7f0decb536a55df01b0e4710aeafdd");
//        new KubernetesApplicationServiceImpl().triggerSavepoint(application);
    }
}
